...
function Shapes(width, height, color, border, borderRadius , transform) {
  ...
  let rectangle = new Shapes("350px", "200px", "blue", "2px solid black");
  let circle = new Shapes("200px", "200px", "pink", "2px solid black", "50%");
  let square = new Shapes("200px", "200px", "green" , "2px solid black");
  let parallelogram = new Shapes("250px" , "200px" , "orange" , "2px solid black" , undefined ,"skew(13deg)" )
  // Declaration Ended
